...
/* Sequential opening */
Tunnel.prototype._open = function(tunnels){
    this._opening = this._opening.then(function(){ return tunnels.open(); }).catch(()=>{})
}
